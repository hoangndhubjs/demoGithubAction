...
class QualificationController extends Controller
{
    ...
    public function qualification()
    {
        ...
        return view("admin.employee.qualification.list", compact('page_title', 'info_user'));
    }
    ...
    public function datatableQualification(Request $request) {
        ...
        $listQualification = $this->qualification->getQualification($paginateConfig, $request->route('id'));
    ...
    public function createFormQualification(Request $request) {
        ...
        return view('admin.employee.qualification.form_modal', compact('qualification', 'type', 'document_type', 'education_level', 'qualification_language'));
    }
