...
class ImmigrationController extends Controller
{
    ...
    public function immigration()
    {
        ...
        return view("admin.employee.immigration.list", compact('page_title', 'info_user', 'document_type'));
    }
    ...
    public function datatableImmigration(Request $request) {
        ...
        $listImmigration = $this->immigration->getImmigration($paginateConfig, $request->route('id'));
    ...
    public function createFormImmigration(Request $request) {
        ...
        return view('admin.employee.immigration.form_modal', compact('immigration', 'type', 'document_type'));
    }
