        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">{{ __("employee_full_allowance") }}
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.timesheet.full_allowance') }}">
                    @csrf
                    <div class="form-group">
                        <select type="text" name="full_allowance[]" id="full_allowance" class="form-control select2" multiple="multiple">
...
@section('scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#full_allowance').select2(options);
        });
