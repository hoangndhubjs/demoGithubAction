...
{{-- Styles Section --}}
@section('styles')
    <link href="{{ mix('plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('scripts')
    ...
    {{-- page scripts --}}
    <script src="{{ mix('js/pages/crud/datatables/basic/basic.js') }}" type="text/javascript"></script>
