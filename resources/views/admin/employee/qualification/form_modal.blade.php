@if(isset($type))
    <form class="form" id="formQualification" method="POST" action="{{ route('employee_managements.ajax.create_qualification', request()->route('id')) }}" enctype="multipart/form-data">
        @csrf
