...
@section('content')
    ...
    <div class="modal fade px-0" id="popupQualification" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="popupQualification" aria-hidden="true" data-form-url="{{ route('ajax.create_form_qualification') }}">
