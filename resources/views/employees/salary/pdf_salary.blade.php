...
{{--                </tr>--}}
            ...
            <table cellpadding="2" cellspacing="0" border="1">
                ...
                <tr>
                    ...
                    <td>{{ $payslip_id['total_overtime_formal'] }}</td>
                    <td>{{ __('total_overtime_trail') }}</td>
                    <td>{{  $payslip_id['total_overtime_trial'] }}</td>
                </tr>
                <tr>
                    <td>{{ __('day_formal_work') }}</td>
                    <td>{{ $payslip_id['total_trial_working_days'] }}</td>
                    <td>{{ __('day_trail_work') }}</td>
                    <td>{{  $payslip_id['total_formal_working_days'] }}</td>
                </tr>
                @if($payslip_id['wages_type'] == 1)
                    <tr>
                        <td>{{ __('total_work_allowance') }}</td>
                        <td>{{ floor($payslip_id['total_formal_working_days']) }}</td>
                        <td>--</td>
                        <td>--</td>
                    </tr>
                @endif
            ...
            <table cellpadding="2" cellspacing="0" border="1">
                ...
                <tr>
                    ...
                    <td>{{ __('advan_money') }} (50%)</td>
                    <td>{{ app('hrm')->getCurrencyConverter()->getUserFormat($payslip_id['total_advance']) }}</td>
                </tr>
            ...
            <table cellpadding="2" cellspacing="0" border="1">
                ...
                <tr>
                    <td  colspan="" align="center"><strong></strong></td>
                    <td colspan="4" align="center"><strong>{{ app('hrm')->getCurrencyConverter()->getUserFormat($payslip_id['grand_net_salary']) }}</strong></td>
                </tr>
            </table>
