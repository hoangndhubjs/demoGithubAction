...
@section('content')
    ...
    <div class="modal fade px-0" id="popupBankAccount" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="popupBankAccount" aria-hidden="true" data-form-url="{{ route('ajax.create_form_bank_account')}}">
